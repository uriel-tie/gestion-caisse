...
final class Version20251222130654 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demande (id UUID NOT NULL, demandeur_id UUID NOT NULL, operation_id UUID DEFAULT NULL, beneficiaire_id UUID DEFAULT NULL, caissier_traitant_id UUID DEFAULT NULL, type VARCHAR(50) NOT NULL, titre VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, montant_estime NUMERIC(12, 2) NOT NULL, statut VARCHAR(50) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, numero_reference VARCHAR(50) DEFAULT NULL, beneficiaire_autre VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
