 ...
 */
final class Version20260121141018 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE audit (id BIGSERIAL NOT NULL, utilisateur_id UUID DEFAULT NULL, societe_id UUID DEFAULT NULL, action VARCHAR(50) NOT NULL, actor_name VARCHAR(255) NOT NULL, entity_class VARCHAR(255) NOT NULL, entity_id VARCHAR(255) NOT NULL, changes JSON DEFAULT NULL, ip_address VARCHAR(45) DEFAULT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE compte_comptable (id UUID NOT NULL, societe_id UUID NOT NULL, numero VARCHAR(20) NOT NULL, libelle VARCHAR(255) NOT NULL, type VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_98EA7D55F55AE19E ON compte_comptable (numero)');
        $this->addSql('CREATE INDEX IDX_98EA7D55FCF77503 ON compte_comptable (societe_id)');
        $this->addSql('COMMENT ON COLUMN compte_comptable.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN compte_comptable.societe_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('COMMENT ON COLUMN justificatif.societe_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN justificatif.date_upload IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE ligne_demande (id UUID NOT NULL, demande_id UUID NOT NULL, compte_id UUID DEFAULT NULL, designation VARCHAR(255) NOT NULL, quantite INT NOT NULL, prix_unitaire_estimatif DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE mode_paiement (id UUID NOT NULL, societe_id UUID NOT NULL, libelle VARCHAR(100) NOT NULL, type VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B2BB0E85A4D60759 ON mode_paiement (libelle)');
        $this->addSql('CREATE INDEX IDX_B2BB0E85FCF77503 ON mode_paiement (societe_id)');
        $this->addSql('COMMENT ON COLUMN mode_paiement.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN mode_paiement.societe_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('CREATE INDEX idx_operation_societe ON operation (societe_id)');
        ...
        $this->addSql('CREATE TABLE security_request (id SERIAL NOT NULL, user_id UUID NOT NULL, code VARCHAR(255) NOT NULL, type VARCHAR(30) NOT NULL, expires_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_567C8482A76ED395 ON security_request (user_id)');
        $this->addSql('COMMENT ON COLUMN security_request.user_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN security_request.expires_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('COMMENT ON COLUMN security_request.created_at IS \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('CREATE TABLE session_caisse (id UUID NOT NULL, caissier_id UUID NOT NULL, caisse_id UUID NOT NULL, societe_id UUID NOT NULL, date_ouverture TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_fermeture TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, statut VARCHAR(50) NOT NULL, montant_ouverture NUMERIC(12, 2) NOT NULL, montant_fermeture NUMERIC(12, 2) DEFAULT NULL, montant_theorique NUMERIC(12, 2) DEFAULT NULL, billetage JSON DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE INDEX IDX_DDC85991FCF77503 ON session_caisse (societe_id)');
        ...
        $this->addSql('COMMENT ON COLUMN session_caisse.societe_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('CREATE TABLE transfert (id UUID NOT NULL, caisse_depart_id UUID NOT NULL, caisse_arrivee_id UUID NOT NULL, emetteur_id UUID NOT NULL, receveur_id UUID DEFAULT NULL, societe_id UUID NOT NULL, montant VARCHAR(255) NOT NULL, statut VARCHAR(50) NOT NULL, date_creation TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_validation TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, motif VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE INDEX IDX_1E4EACBBFCF77503 ON transfert (societe_id)');
        ...
        $this->addSql('COMMENT ON COLUMN transfert.societe_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('CREATE TABLE utilisateur (id UUID NOT NULL, service_id UUID DEFAULT NULL, societe_id UUID DEFAULT NULL, custom_role_id UUID DEFAULT NULL, nom VARCHAR(255) NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, est_actif BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, password_must_be_changed BOOLEAN DEFAULT true NOT NULL, derniere_modification_nom TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, google_authenticator_secret VARCHAR(255) DEFAULT NULL, is2fa_enabled BOOLEAN NOT NULL, is_deleted BOOLEAN DEFAULT false NOT NULL, is_email_verified BOOLEAN DEFAULT false NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE compte_comptable ADD CONSTRAINT FK_98EA7D55FCF77503 FOREIGN KEY (societe_id) REFERENCES societe (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE justificatif ADD CONSTRAINT FK_90D3C5DCFCF77503 FOREIGN KEY (societe_id) REFERENCES societe (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE mode_paiement ADD CONSTRAINT FK_B2BB0E85FCF77503 FOREIGN KEY (societe_id) REFERENCES societe (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE security_request ADD CONSTRAINT FK_567C8482A76ED395 FOREIGN KEY (user_id) REFERENCES utilisateur (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE session_caisse ADD CONSTRAINT FK_DDC85991FCF77503 FOREIGN KEY (societe_id) REFERENCES societe (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE transfert ADD CONSTRAINT FK_1E4EACBBFCF77503 FOREIGN KEY (societe_id) REFERENCES societe (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE compte_comptable DROP CONSTRAINT FK_98EA7D55FCF77503');
        ...
        $this->addSql('ALTER TABLE justificatif DROP CONSTRAINT FK_90D3C5DCFCF77503');
        ...
        $this->addSql('ALTER TABLE mode_paiement DROP CONSTRAINT FK_B2BB0E85FCF77503');
        ...
        $this->addSql('ALTER TABLE security_request DROP CONSTRAINT FK_567C8482A76ED395');
        ...
        $this->addSql('ALTER TABLE session_caisse DROP CONSTRAINT FK_DDC85991FCF77503');
        ...
        $this->addSql('ALTER TABLE transfert DROP CONSTRAINT FK_1E4EACBBFCF77503');
        ...
        $this->addSql('DROP TABLE security_request');
